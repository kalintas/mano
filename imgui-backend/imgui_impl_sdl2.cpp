...
//  [X] Platform: Keyboard support. Since 1.87 we are using the io.AddKeyEvent() function. [Legacy SDL_SCANCODE_* values are obsolete since 1.87 and not supported since 1.91.5]
